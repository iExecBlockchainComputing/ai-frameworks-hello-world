...
output_path = os.path.join(output_directory, "result.jpg")

cv2.imwrite(output_path, cv2.cvtColor(convert_result_to_image(image, resized_image, boxes, conf_labels=False), cv2.COLOR_RGB2BGR))
